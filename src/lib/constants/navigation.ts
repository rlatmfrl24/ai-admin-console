    ...
    children: [
        ...
        children: [
          {
            ...
            children: [
              {
                label: "서버 성능 모니터링",
                id: "server-performance-monitoring",
                description: "Monitors server performance metrics",
              },
              {
                label: "리소스 사용량 모니터링",
                id: "resource-usage-monitoring",
                description: "Tracks server resource consumption",
              },
            ],
          },
          {
            label: "서버 로그 관리",
            id: "server-log-management",
            description: "Manages server log operations",
            children: [
              {
                label: "서버 로그",
                id: "server-log",
              ...
              {
                label: "로그 분석 도구",
                id: "log-analysis-tools",
                description: "Provides tools for log analysis",
              },
            ],
          },
          {
            label: "서버 알림 관리",
            id: "server-alert-management",
            description: "Manages server alert and notification system",
            children: [
              {
                label: "알림 규칙 설정",
                id: "alert-rules",
                description: "Configures server alert rules",
              },
              {
                label: "알림 이력",
                id: "alert-history",
                description: "Tracks server alert history",
              },
            ],
          },
        ],
      },
      {
        ...
        children: [
          {
            label: "라이선스 정보 관리",
            id: "license-info-management",
            description: "Manages license information operations",
            children: [
              {
                label: "라이선스 정보",
                id: "license-info",
              ...
              },
              {
                label: "라이선스 상세 정보",
                id: "license-details",
                description: "Views detailed license information",
              },
            ],
          },
          {
            label: "라이선스 갱신 관리",
            id: "license-renewal-management",
            description: "Manages license renewal operations",
            children: [
              {
                label: "라이선스 갱신",
                id: "license-renewal",
          ...
          },
          {
            ...
            description: "Monitors license status and expiration",
            children: [
              {
                label: "만료 알림 설정",
                id: "expiration-alerts",
                description: "Configures license expiration alerts",
              },
              {
                label: "라이선스 사용 통계",
                id: "license-usage-statistics",
                description: "Tracks license usage patterns",
              },
            ],
          },
        ],
        ...
        children: [
          {
            ...
            description: "Manages API key operations",
            children: [
              {
                label: "API 키 목록",
                id: "api-key-list",
          ...
          {
            label: "API 사용 관리",
            id: "api-usage-management",
            description: "Manages API usage operations",
            children: [
              {
                label: "API 사용 이력",
              ...
              },
              {
                label: "API 사용량 제한",
                id: "api-usage-limits",
                description: "Manages API usage limits and quotas",
              },
            ],
          },
          {
            ...
            description: "Manages API security and access control",
            children: [
              {
                label: "API 접근 제어",
                id: "api-access-control",
                description: "Controls API access permissions",
              },
              {
                label: "API 보안 정책",
                id: "api-security-policy",
                description: "Manages API security policies",
              },
            ],
          },
        ],
